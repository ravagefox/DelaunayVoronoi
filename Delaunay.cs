...
namespace DelaunayVoronoi
{
    public class DelaunayTriangulator
    {
        ...
        public IEnumerable<Triangle> CalculateBorder(double maxX, double maxY)
        {
            ...
            return new List<Triangle>()
            {
                ...
                new Triangle(point0, point2, point3),
            };
        }
        ...
        public IEnumerable<Point> GeneratePoints(int amount, double maxX, double maxY)
        {
            ...
            this.border = this.CalculateBorder(maxX, maxY).ToList();
            var points = this.border.SelectMany(t => t.Vertices).ToList();
